...
const companyDetail: React.CSSProperties | undefined = {
    fontSize: "18px",
    color: "#000",
    fontWeight: "700",
}

const userName: React.CSSProperties | undefined = {
    fontSize: "18px",
    color: "#000",
    fontWeight: "600",
}
...
const adminInfo: React.CSSProperties | undefined = {
    color: "#1D1F2C",
    fontSize: "16px",
    fontWeight: "700",
}

const adminName: React.CSSProperties | undefined = {
    color: "#1D1F2C",
    fontSize: "14px",
    fontWeight: "500",
}
