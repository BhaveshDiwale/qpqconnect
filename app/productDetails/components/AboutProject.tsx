...
interface EssentialDetailProps {
    label: string;
    value: string;
}

export const EssentialDetail = ({ label, value }: EssentialDetailProps) => {
    return (
...
const descriptionStyles: React.CSSProperties | undefined = {
    fontSize: "24px",
    color: "#000",
    fontWeight: "700",
}

const descriptionInfoStyles: React.CSSProperties | undefined = {
    fontSize: "16px",
    color: "#5E7384",
    fontWeight: "600",
    lineHeight: "26px",
