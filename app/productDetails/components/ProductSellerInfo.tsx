...
const IconTextBox = ({ icon, text1, text2 }: IconTextBoxProps) => {
    return (
...
const sellerName: React.CSSProperties | undefined = {
    fontSize: "14px",
    color: "#1D1F2C",
    fontWeight: "700",
}

const activeBtn: React.CSSProperties | undefined = {
...
const iconBox: React.CSSProperties | undefined = {
...
const gstStyles: React.CSSProperties | undefined = {
    fontSize: "12px",
    color: "#667085",
    fontWeight: "700",
}

const gstValStyles: React.CSSProperties | undefined = {
    fontSize: "12px",
    color: "#1D1F2C",
    fontWeight: "700",
}

const viewNumberBtn: React.CSSProperties | undefined = {
...
const contactSellerBtn: React.CSSProperties | undefined = {
    padding: "6px",
    borderRadius: "8px",
    fontSize: "12px",
    fontWeight: "600",
