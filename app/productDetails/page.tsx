...
const enquiryToSupplierStyle: React.CSSProperties | undefined = {
    fontSize: "16px",
    color: "#000",
    fontWeight: "700",
}
...
const supplierNameStyle: React.CSSProperties | undefined = {
    fontSize: "14px",
    color: "#000",
    fontWeight: "700",
}
...
const essentialdetailsStyles: React.CSSProperties | undefined = {
    fontSize: "12px",
    color: "#333",
    fontWeight: "900",
    marginTop: "24px"
