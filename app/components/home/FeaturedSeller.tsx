...
interface RenderIconBlockProps {
    name: any;
    icon: string;
}

const RenderIconBlock = ({ name, icon }: RenderIconBlockProps) => {
    return (
...
const topBorder: React.CSSProperties | undefined = {
    width: "84px",
    height: "6px",
    backgroundColor: "#000",
    marginBottom: "24px",
...
const infoStyles: React.CSSProperties | undefined = {
    fontSize: "11px",
    color: "#737373",
    fontWeight: "500",
    textAlign: "left",
...
const learnMore: React.CSSProperties | undefined = {
    fontSize: "14px",
    color: "#000",
    fontWeight: "700",
    textAlign: "left",
...
const iconBackground: React.CSSProperties | undefined = {
    width: "42px",
    height: "42px",
    borderRadius: "100px",
    backgroundColor: "#000",
...
const iconNameStyle: React.CSSProperties | undefined = {
    fontSize: "13px",
    color: "#000",
    fontWeight: "500",
    marginTop: "2px",
